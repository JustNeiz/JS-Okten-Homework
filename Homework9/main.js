...
//     div.innerText = `title - ${elem.title}, month duration - ${elem.monthDuration}`;
...
//     p.innerText = `Duration is ${elem.monthDuration} month`;
//     div.appendChild(p);
// }
...
//     member.style.margin = '20px';
//     member.style.padding = '20px';
//     member.style.width = '60vw';
//     member.style.border = '8px solid black';
//     document.body.appendChild(member);
//     for (const simpsonKey in simpson) {
//         if(typeof simpson[simpsonKey] !== 'string' || !simpson[simpsonKey].includes('http')) {
//             let info = document.createElement('h6');
//             info.innerText = `${simpsonKey} : ${simpson[simpsonKey]}`
//             member.appendChild(info)
//         } else {
//             let info = document.createElement('img')
//             info.src = `${simpson[simpsonKey]}`;
//             member.appendChild(info);
//         }
//     }
// }
...
//         // console.log(elem[elemKey]);
//         if(elemKey !== 'modules'){
//             info.innerText = `${elemKey} is ${elem[elemKey]}`
//             wrap.appendChild(info);
//         }else {
//             let ul = document.createElement('ul');
//             ul.innerText = elemKey.toUpperCase();
//             ul.style.border = '3px solid black';
//             ul.style.margin = '10px';
//             ul.style.padding = '20px';
//             ul.style.width = '50vw';
//             wrap.appendChild(ul);
//             for (const module of elem[elemKey]){
//                 let li = document.createElement('li');
//                 li.innerText = module;
//                 ul.appendChild(li);
//             }
